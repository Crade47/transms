...
class SmsMessage extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'SmsMessage', package: const $pb.PackageName(_omitMessageNames ? '' : 'smsproto'), createEmptyInstance: create)
...
class SmsRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'SmsRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'smsproto'), createEmptyInstance: create)
